...
import {SignupPhone,SignupEmail,CreateName,CreateDateOfBirth} from "~/pages/Auth/Signup";
import SearchAccount from "~/pages/Search/SearchAccount";
...
const publicRoutes = [
  ...
  { path: config.routes.searchaccount, component: SearchAccount},
  { path: config.routes.searchvideo, component: SearchVideo},
  ...
  { path: config.routes.resetwithemail, component: () => <ResetPassword resetWith="email"/> ,layout:null},
  { path: config.routes.resetwithphone, component: () => <ResetPassword resetWith="phone"/> ,layout:null},
  { path: config.routes.signup, component: () => <Auth isFormLogin={false}/> ,layout:null},
  ...
  { path: config.routes.createdateofbirth, component: CreateDateOfBirth ,layout:null},
];
const privateRoutes = [];
